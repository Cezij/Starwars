package com.cezij.csmp.registry.structures.costum;
...
public class SkyStructures extends Structure {
    ...
    // A custom codec that changes the size limit for our code_structure_jedi_temple.json's config to not be capped at 7.
    ...
    public static final Codec<SkyStructures> CODEC = RecordCodecBuilder.<SkyStructures>mapCodec(instance ->
            instance.group(SkyStructures.configCodecBuilder(instance),
                    ...
                    Codec.intRange(0, 150).fieldOf("size").forGetter(structure -> structure.size),
