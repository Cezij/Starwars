...
public class CrystalMeth extends Item implements PolymerItem{

    public CrystalMeth(Settings settings) {
        super(settings);
    }
    ...
    public static void registerItems(){
        Registry.register(Registry.ITEM,new Identifier(SmpMod.MOD_ID,"crystal_meth"),new CrystalMeth(new Settings().group(ItemGroup.FOOD).food(ModFoodComponents.CRYSTAL_METH)));
        PolymerModelData modelData = PolymerRPUtils.requestModel(Items.PORKCHOP, new Identifier(SmpMod.MOD_ID, "item/crystal_meth"));
    }
}
