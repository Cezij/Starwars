...
public class RedCrystal extends Item implements PolymerItem{

    public RedCrystal(Settings settings) {
        super(settings);
    }
    ...
    public static void registerItems(){
        Registry.register(Registry.ITEM,new Identifier(SmpMod.MOD_ID,"red_kyber_crystal"),new RedCrystal(new Item.Settings().group(ItemGroup.COMBAT).fireproof()));
        PolymerModelData modelData = PolymerRPUtils.requestModel(Items.DIAMOND, new Identifier(SmpMod.MOD_ID, "item/red_kyber_crystal"));
    }
}
