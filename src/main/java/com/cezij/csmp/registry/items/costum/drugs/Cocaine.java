...
public class Cocaine extends Item implements PolymerItem{
    ...
    public static void registerItems(){
        Registry.register(Registry.ITEM,new Identifier(SmpMod.MOD_ID,"cocaine"),new Cocaine(new Settings().group(ItemGroup.FOOD).food(ModFoodComponents.DRUGS)));
        PolymerModelData modelData = PolymerRPUtils.requestModel(Items.PORKCHOP, new Identifier(SmpMod.MOD_ID, "item/cocaine"));
    }
}
