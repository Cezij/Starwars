...
public class BlueSabor extends SwordItem implements PolymerItem {



    public BlueSabor(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
