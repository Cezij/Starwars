...
public class BlueCrystal extends Item implements PolymerItem{

    public BlueCrystal(Settings settings) {
        super(settings);
    }
    ...
    public static void registerItems(){
        Registry.register(Registry.ITEM,new Identifier(SmpMod.MOD_ID,"blue_kyber_crystal"),new BlueCrystal(new Item.Settings().group(ItemGroup.COMBAT).fireproof()));
        PolymerModelData modelData = PolymerRPUtils.requestModel(Items.DIAMOND, new Identifier(SmpMod.MOD_ID, "item/blue_kyber_crystal"));
    }
}
