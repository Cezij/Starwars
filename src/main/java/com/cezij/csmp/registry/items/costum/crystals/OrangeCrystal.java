...
public class OrangeCrystal extends Item implements PolymerItem{

    public OrangeCrystal(Settings settings) {
        super(settings);
    }
    ...
    public static void registerItems(){
        Registry.register(Registry.ITEM,new Identifier(SmpMod.MOD_ID,"orange_kyber_crystal"),new OrangeCrystal(new Item.Settings().group(ItemGroup.COMBAT).fireproof()));
        PolymerModelData modelData = PolymerRPUtils.requestModel(Items.DIAMOND, new Identifier(SmpMod.MOD_ID, "item/orange_kyber_crystal"));
    }
}
