...
public class ModItems implements PolymerItem {
    ...
    public static final SimplePolymerItem PURPULE_KYBER_CRYSTAL = new SimplePolymerItem(new Item.Settings().group(ItemGroup.TRANSPORTATION).fireproof(), Items.DIAMOND);
