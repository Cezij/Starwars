...
import com.cezij.csmp.registry.items.ModItemTags;
...
public class ModBlaster extends RangedWeaponItem implements PolymerItem {




    public ModBlaster(Settings settings) {
        super(settings);
    }
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        if ((double)(f = ModBlaster.getPullProgress(i = this.getMaxUseTime(stack) - remainingUseTicks)) < 0.1) {
            return;
        }
