...
public class ModCrossGuard extends SwordItem implements PolymerItem {



    public ModCrossGuard(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
