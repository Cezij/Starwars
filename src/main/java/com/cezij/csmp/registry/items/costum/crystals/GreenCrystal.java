...
public class GreenCrystal extends Item implements PolymerItem{

    public GreenCrystal(Settings settings) {
        super(settings);
    }
    ...
    public static void registerItems(){
        Registry.register(Registry.ITEM,new Identifier(SmpMod.MOD_ID,"green_kyber_crystal"),new GreenCrystal(new Item.Settings().group(ItemGroup.COMBAT).fireproof()));
        PolymerModelData modelData = PolymerRPUtils.requestModel(Items.DIAMOND, new Identifier(SmpMod.MOD_ID, "item/green_kyber_crystal"));
    }
}
